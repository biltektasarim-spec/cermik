...
$district_id = 3; // Çermik için sabitlendi
...
function resolve_image_path($path) {
    ...
    if (strpos($path, 'assets/') === 0 || strpos($path, 'uploads/') === 0) {
        // Yerel klasörde (cermik/assets veya cermik/uploads) varsa direkt kullan
...
<head>
    ...
    <title><?php echo __('pharmacy_title'); ?> - <?php echo $settings['site_name'] ?? 'Çermik'; ?></title>
...
<body data-page-context="<?php echo __('pharmacy_title'); ?>" data-district-slug="cermik">
