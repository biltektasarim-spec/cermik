class AppConfig {
  static const String appName = 'Eğil Belediyesi';
  
  // Canlı sunucu erişimi için
  static String get apiBaseUrl {
    return 'https://egil.rotarehber.com/laravel_api/public/api/v1/';
  }

  /// Web sitesi ana URL'si — Paylaş linkleri için kullan (API URL'si değil!)
  static String get webBaseUrl => 'https://egil.rotarehber.com';

  static String get baseUrl => webBaseUrl;
  
  static String get baseMediaUrl {
    return 'https://egil.rotarehber.com/';
  }
