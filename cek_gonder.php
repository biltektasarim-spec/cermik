...
if ($district_id == 0 && isset($_SESSION['user_id'])) {
    $stmtUserDist = $pdo->prepare("SELECT district_id FROM users WHERE id = ?");
    $stmtUserDist->execute([$_SESSION['user_id']]);
    $district_id = $stmtUserDist->fetchColumn() ?: 0;
}
...
<head>
    ...
    <title><?php echo __('cek_gonder_title'); ?> | <?php echo __('belediye_rehberi'); ?></title>
...
<div id="app">
    ...
    <div style="background: linear-gradient(135deg, rgba(26,107,60,0.85), rgba(39,174,96,0.7)),
        ...
        <h2 style="font-size: 1.6rem; font-weight: 800; margin-bottom: 8px; color: white;"><?php echo __('cek_gonder'); ?></h2>
    ...
    <main class="section animate-in" style="padding-top: 20px;">
        ...
        <div class="card animate-in" id="form-card">
            ...
            <div class="basvuru-turu-grid">
                <button type="button" class="basvuru-turu-btn" onclick="selectTur('Bilgilendirme', this)">
                    <i class="fa-solid fa-circle-info" style="color: #3498db;"></i>
                    <?php echo __('info_type'); ?>
                </button>
                <button type="button" class="basvuru-turu-btn" onclick="selectTur('İstek', this)">
                    <i class="fa-solid fa-hand" style="color: #9b59b6;"></i>
                    <?php echo __('request_type'); ?>
                </button>
                <button type="button" class="basvuru-turu-btn" onclick="selectTur('Öneri', this)">
                    <i class="fa-solid fa-lightbulb" style="color: #f39c12;"></i>
                    <?php echo __('suggestion_type'); ?>
                </button>
                <button type="button" class="basvuru-turu-btn" onclick="selectTur('Şikayet', this)">
                    <i class="fa-solid fa-triangle-exclamation" style="color: #e74c3c;"></i>
                    <?php echo __('complaint_type'); ?>
                </button>
                <button type="button" class="basvuru-turu-btn full-width" onclick="selectTur('Teşekkür', this)">
                    <i class="fa-solid fa-heart" style="color: #e91e63;"></i>
                    <?php echo __('thanks_type'); ?>
                </button>
            </div>
            ...
            <div class="photo-upload-grid">
                ...
                <div class="photo-upload-box" id="box1" onclick="document.getElementById('foto1').click()">
                    <input type="file" id="foto1" accept="image/*" capture="environment" onchange="previewPhoto(this, 'box1')" onclick="event.stopPropagation()">
                ...
                <div class="photo-upload-box" id="box2" onclick="document.getElementById('foto2').click()">
                    <input type="file" id="foto2" accept="image/*" capture="environment" onchange="previewPhoto(this, 'box2')" onclick="event.stopPropagation()">
                    <i class="fa-solid fa-camera upload-icon"></i>
                ...
                <div class="photo-upload-box" id="box3" onclick="document.getElementById('foto3').click()">
                    <input type="file" id="foto3" accept="image/*" capture="environment" onchange="previewPhoto(this, 'box3')" onclick="event.stopPropagation()">
                    <i class="fa-solid fa-camera upload-icon"></i>
